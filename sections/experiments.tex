...
We report the runtime analysis and multi-budget scores in Appendix \ref{appendix:additional}. The results are qualitatively similar to our experiments under size constraint.
