...
def main():
    ...
    parser.add_argument("--budget", type=int, default= 100, help="Budget to use")
    ...
    for budget in [1,10,25,50,75,100]:
    ...
    print(results)
    results_folder = f"multibudget/{problem}/{train_dataset}/results"
