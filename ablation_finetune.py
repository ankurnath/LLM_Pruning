...
def main():
    ...
    best_model_data_path = os.path.join(f"simple_feedback/{problem}/{base_dataset}", "best_model_data.pkl")
    ...
    os.makedirs(save_folder, exist_ok=True)
    finetune_model_save_path = os.path.join(save_folder, "best_model.pth")
